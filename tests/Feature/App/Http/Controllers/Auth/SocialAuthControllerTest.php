...
class SocialAuthControllerTest extends TestCase
{
    ...
    private function mockSocialiteCallback(string|int $githubId)
    {
    ...
    public function it_driver_not_found_exception(): void
    {
        ...
        $this
            ...
            ->get(
                action([SocialAuthController::class, 'redirect'], ['driver' => 'vk'])
            );

        $this
            ->withoutExceptionHandling()
            ->get(
                action([SocialAuthController::class, 'callback'], ['driver' => 'vk'])
            );
    }
